...
<body class="skin-blue">
             ...
             <div class="col-md-12">
                ...
                <div class="box box-primary">
                    	<div class="box-header">
                            <h3 class="box-title">资讯修改</h3>
                        </div>
                        <div class="box-body">
                            <form id="activity-form">
                               <input type="hidden" name="news_id" value= "${modify_news.news_id!""}"  />
                                  ...
                                  <div class="row">
                                      <div class="col-md-4">
                                           <div class="input-group">
                                                ...
                                                <input type="text" name="title" value="${modify_news.title!""}" class="form-control" />
                                           </div>
                                      </div>
                                      <div class="col-md-3">
                                           <div class="input-group">
                                                <span class="input-group-addon">类型</span>
						                       	<select name="type" value="${modify_news.type!""}" style="border:1px solid #ccc;width:180px;height:34px;line-height:34px;" >
						                       		<#if modify_news.type == "1">
						                       		<option value="1">象网新闻</option>
						                       		<option value="2">行业动态</option>
						                       		<option value="3">修车养车</option>
						                       		</#if>
						                       		<#if modify_news.type == "2">
						                       		<option value="2">行业动态</option>
						                       		<option value="1">象网新闻</option>
						                       		<option value="3">修车养车</option>
						                       		</#if>
						                       		<#if modify_news.type == "3">
						                       		<option value="3">修车养车</option>
						                       		<option value="1">象网新闻</option>
						                       		<option value="2">行业动态</option>
						                       		</#if>
                                      ...
                                      <div class="col-md-3">
                                           <div class="input-group ">
                                               ...
                                               <input class="easyui-datetimebox" name="in_date" value="${modify_news.in_date!""}" style="height:34px;">
                                                <!--
                                                <input type="date" name="date"  class="form-control col-md-6"  />
                                                <input type="time" name="time"  class="form-control col-md-6" />
                                                -->
                                           </div>
                                      </div>
                                      <div class="col-md-2">
                                           <label>
                                           <input type="checkbox" name="state" value="${modify_news.state!""}" class="minimal-red"<#if modify_news.state?exists><#if modify_news.state == "1"> checked</#if></#if>/>
                                           </label>
                                           <label>是否发布</label>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-9">
                                           <div class="row">
                                               ...
                                               <div class="form-group">
                                                    <label>详细说明</label>
                                                    <textarea id="html-content" name="content" class="form-control" rows="20" placeholder="请输入 ...">${modify_news.content!""}</textarea>
                                               </div>
                                               </div>
                                           </div>
                                      </div>
    ...
    function onUpNewsChange(id){
       ...
       function save(){
           ...
           $.ajax({
               url: "/runtime/services/service_update_news",
               type: "post",
               data: params,
               success: function(data){
                    onUpdate(data);
